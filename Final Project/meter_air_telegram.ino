...
#define BOTtoken "6903766309:AAGZTPvuskX2ATVlZZEdVSD5__MDhG73XwE"  
#define idAnda "1239071871"
...
// masukan perintah disini
 ...
 if (txtBuff == "Cek"){
   bot.sendMessage(idAnda,"Nih ! ketinggian Air Sekarang: "+ String(tinggiAir)  +  " Cm" , "");
...
if (millis() > Bot_lasttime + Bot_mtbs) //1500
  ...
  if (tinggiAir <= alarmHabis && flag1 == false){
    ...
    bot.sendMessage(idAnda,"Pemberitahuan gan, Air Habis : "  + String(tinggiAir)  +  " Cm", "");
  ...
  if (tinggiAir >= alarmPenuh && flag2 == false){
    ...
    bot.sendMessage(idAnda,"Pemberitahuan gan, Air Penuh : "  + String(tinggiAir)  +  " Cm", "");
...
if (millis() > bufKirimPesan + x)
{
    ...
    bot.sendMessage(idAnda,"PESAN OTOMATIS , Ketinggian Airnya segini gan : "  + String(tinggiAir)  +  " Cm", "");
